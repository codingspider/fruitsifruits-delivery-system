...
import { DASHBOARD_PATH, DRIVER_ADD_PATH, DRIVER_EDIT_PATH } from "../../router";
...
export default function DriverList() {
    ...
    useEffect(() => {
        ...
        document.title = `${app_name} | Driver List`;
        fetchOwners();
    ...
    const deleteOwner = async (id) => {
        ...
        if (result.isConfirmed) {
            try {
                await api.delete(`superadmin/drivers/${id}`);
                toast({
                ...
                <>
                    <Box display="flex" gap={2}>
                        <ChakraLink
                            ...
                            borderRadius="md"
                            onClick={() =>
                                navigate(DRIVER_EDIT_PATH(row.original.id))
                            }
                        >
                            <EditIcon />
                        </ChakraLink>
