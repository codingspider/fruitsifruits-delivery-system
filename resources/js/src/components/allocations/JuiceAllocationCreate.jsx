...
const JuiceAllocationCreate = () => {
    ...
    const onSubmit = async () => {
        ...
        try {
            ...
            console.log(payload);
            const res = await api.post("superadmin/driver/juice/allocations", payload);
            reset();
            toast({
                ...
                <Card shadow="md" borderRadius="2xl">
                    <CardHeader>
                        <Flex mb={4} justifyContent="space-between">
                            <Heading size="md">{t("add_driver_allocation")}</Heading>
                            <Button
                                colorScheme="teal"
                                as={ReactRouterLink}
...
export default JuiceAllocationCreate;
