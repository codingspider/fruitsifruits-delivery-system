...
import { DASHBOARD_PATH, DRIVER_DASHBOARD_PATH, DRIVER_REPORT_PATH, JUICE_ALLOCATION_LIST_PATH } from "../../router";

const ReturnLeftover = () => {
    ...
    const onSubmit = async () => {
        ...
        try {
            ...
            const res = await api.post("/driver/return/leftover", payload);
            toast({
            ...
            navigate(DRIVER_DASHBOARD_PATH);
    ...
    useEffect(() => {
        ...
        document.title = `${app_name} | Return Leftover`;
        getFlavours();
        getProducts();
        getBottles();
    }, []);
                ...
                <CardBody>
                    <Breadcrumb fontSize={{ base: "sm", md: "md" }}>
                        ...
                        <BreadcrumbItem isCurrentPage>
                            <BreadcrumbLink as={ReactRouterLink} to={DRIVER_REPORT_PATH}>
                                {t("list")}
                            </BreadcrumbLink>
                        </BreadcrumbItem>
                    </Breadcrumb>
                ...
                <Card shadow="md" borderRadius="2xl">
                    <CardHeader>
                        <Flex mb={4} justifyContent="space-between">
                            <Heading size="md">{t("add_return_leftover")}</Heading>
                        </Flex>
                    </CardHeader>
