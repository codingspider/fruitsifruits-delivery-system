...
const Stats = () => {
    ...
    const [toBeDelivered, setToBeDelivered] = useState(null);
    ...
    const DashboardStats = async () => {
        try {
            ...
            setToBeDelivered(res.data.data.to_be_delivered);
        } catch (err) {
        ...
        <>
            ...
            >
                ...
                <Card>
                    ...
                    <CardBody>
                        <Heading size="sm">{toBeDelivered}</Heading>
                    </CardBody>
                    <CardFooter>
                        <Button colorScheme="teal" size="sm">
                            {t("details")}
                ...
                <Card>
                    ...
                    <CardBody>
                        <Heading size="sm">{toBeDelivered - totalDelivered}</Heading>
                    </CardBody>
                    <CardFooter>
                        <Button colorScheme="teal" size="sm">
                            {t("details")}
