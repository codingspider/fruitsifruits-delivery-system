...
import { DASHBOARD_PATH, FINISH_GOOD_ADD_PATH } from "../../router";
import { EditIcon, DeleteIcon } from "@chakra-ui/icons";
import Swal from "sweetalert2";
import { Link as ReactRouterLink } from "react-router-dom";
import { FINISH_GOOD_EDIT_PATH } from './../../router';
                ...
                <>
                    <Box display="flex" gap={2}>
                        <ChakraLink
                            ...
                            borderRadius="md"
                            onClick={() =>
                                navigate(FINISH_GOOD_EDIT_PATH(row.original.id))
                            }
                        >
                            <EditIcon />
                        </ChakraLink>
